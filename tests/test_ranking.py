...
def test_ranking_by_price():
    ...
    assert (
        ranked[0]["price"] + ranked[0]["shipping_cost"]
        <= ranked[1]["price"] + ranked[1]["shipping_cost"]
    )
    ...
    products = [
        {
            ...
            "price": 100.0,
            "shipping_cost": 0.0,
            "deal_info": {"is_deal": True, "savings_percent": 20.0, "deal_badge": "Save 20%"},
        },
        {"id": "prod2", "price": 90.0, "shipping_cost": 5.0, "deal_info": {"is_deal": False}},
    ]
...
def test_customer_value_calculation():
    ...
    product = {
        ...
        "rating": 4.5,
        "reviews": 100,
        "deal_info": {"is_deal": True, "savings_percent": 15.0},
        "coupon_info": {"has_coupon": False},
    }
...
def test_ranking_explanation():
    ...
    product = {
        ...
        "rating": 4.5,
        "deal_info": {"is_deal": True, "savings_percent": 20.0, "deal_badge": "Save 20%"},
        "price_comparison": {"retailer_count": 3, "savings_percent": 10.0},
    }
