...
class AgentReasoner:
    ...
    def determine_intent(self, query: str) -> Dict[str, Any]:
        ...
        intent = {"type": "general", "confidence": 0.5, "tools_needed": []}
        ...
        # Question intent
            ...
            word in query_lower for word in ["how", "why", "what is", "tell me about", "explain"]
        ):
        ...
        # Price/availability check
            ...
            word in query_lower for word in ["price", "cost", "available", "in stock", "how much"]
        ):
            intent["type"] = "check"
            intent["confidence"] = 0.8
        ...
        # Comparison
            ...
            word in query_lower for word in ["compare", "difference", "better", "vs", "versus"]
        ):
            intent["type"] = "compare"
            intent["confidence"] = 0.8
