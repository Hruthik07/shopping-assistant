...
async def get_metrics() -> Dict[str, Any]:
    ...
    metrics = {"timestamp": time.time(), "cache": {}, "latency": {}, "system": {}}
    ...
    try:
        ...
        metrics["system"] = {"note": "psutil not available - install for detailed system metrics"}
    except Exception as e:
...
async def get_cache_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": str(e), "enabled": cache_service.enabled}
...
async def get_latency_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        regression_alert = performance_monitor.check_regression(
            threshold_p95=20.0, threshold_p99=30.0  # Alert if P95 > 20s  # Alert if P99 > 30s
        )
        ...
        return {"error": str(e), "note": "Detailed latency metrics are tracked via Langfuse"}


@router.get("/cost")
async def get_cost_metrics(days: int = 7, model: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "price_comparison": {
                ...
                "products_with_multiple_retailers": metrics.get(
                    "products_with_multiple_retailers", 0
                ),
                "average_retailers_per_product": round(
                    metrics.get("average_retailers_per_product", 0.0), 2
                ),
