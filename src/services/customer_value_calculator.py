...
class CustomerValueCalculator:
    ...
    def __init__(self):
        ...
        self.category_weights = {
            ...
            "clothing": {"price": 0.45, "rating": 0.05},  # Lower weight on rating for clothing
            "books": {"price": 0.5, "shipping": 0.3},  # Shipping matters more for books
        }
    ...
    def calculate_customer_value_score(
        self, product: Dict[str, Any], weights: Optional[Dict[str, float]] = None
    ) -> float:
